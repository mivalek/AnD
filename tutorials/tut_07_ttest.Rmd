...
# IMPORTANT: A previous version of ggplot used `fun.y =` instead of `fun =`
# It will still work with `fun.y =` but you'll get a warning
```
...
sync %>%
  ...
  geom_point(stat = "summary", fun = mean, shape = 21, size = 5, fill = "#008080") +
