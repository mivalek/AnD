...
1. Once the module convenor has notified you that the moderation has been completed, run the code inside marking_script.R, [editing as appropriate][Knitting marked .Rmd files].
1. Upload all marked .Rmd and knitted HTML files back into your Box folder.
