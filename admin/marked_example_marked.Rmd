...
```{r packages, include=T, results='hide'}
library(tidyverse)
library(kableExtra)
library(cowplot)
library(weights)
...
```{r checking, include = T, results='hide'}
data <- data %>% 
...
```{r cleaning, include = T, results='hide'}
...
First of all, let's focus on the strong points of your report:
